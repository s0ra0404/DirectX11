// Application.cpp : アプリケーションのエントリ ポイントを定義します。
//
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   int newWidth = (rcWnd.right - rcWnd.left) - (rcClient.right - rcClient.left) + 1920;
   int newHeight = (rcWnd.bottom - rcWnd.top) - (rcClient.bottom - rcClient.top) + 1080;
